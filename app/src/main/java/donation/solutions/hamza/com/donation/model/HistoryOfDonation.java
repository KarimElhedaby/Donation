...
public class HistoryOfDonation {
    private final List<Doner> doner;
    ...
    public HistoryOfDonation(List<Doner> doner, String status, List<String> img,
    ...
    public static class Doner {
        ...
        public Doner(String type, String img, String creationDate, String id, String name,
